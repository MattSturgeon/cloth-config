...
//    }
    ...
    public static class Requirements {
        ...
        public @interface EnableIf {
             ...
             *     <ul>
             *         <li>{@code true} for: {@code "true"}, {@code "t"}, {@code "yes"}, {@code "y"}, {@code "on"}, {@code "enabled"}, or {@code "1"}.
             *         <li>{@code false} for: {@code "false"}, {@code "f"}, {@code "no"}, {@code "n"}, {@code "off"}, {@code "disabled"}, or {@code "0"}.
             *     </ul>
             ...
             *     <li>{@link Short short}, {@link Integer int}, {@link Long long}, {@link Float float}, or {@link Double double}: The arg will be parsed using the appropriate method,
         ...
         * 
         * <p>Otherwise identical to {@link EnableIf}
         *
         * @see EnableIf
         * @see HideableWidget
         */
     ...
     *
     * <p>{@link #value() value} should be the name of the {@code ConfigEntry}'s defining field.
     * <p>{@link #cls() cls} defines the class in which to look for the field.
